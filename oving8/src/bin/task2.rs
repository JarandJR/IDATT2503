...
fn main() {
    ...
    println!("a)\nResult OTP    x1 with k1: {:?}", bytes_to_hex(&result1_otp));
    println!("Result OTP    x2 with k1: {:?}\n", bytes_to_hex(&result2_otp));
    println!("Result Affine x1 with k1: {:?}", bytes_to_hex(&result1_affine));
    println!("Result Affine x2 with k1: {:?}\n", bytes_to_hex(&result2_affine));
